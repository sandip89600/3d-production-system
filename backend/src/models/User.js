...
const userSchema = new mongoose.Schema({
  ...
  role: {
    type: String,
    enum: ['developer', 'admin', 'employee', 'client'],
    required: true,
  },
  adminCode: {
    type: String,
  ...
  failedLoginAttempts: { type: Number, default: 0, alias: 'loginAttempts' },
  accountLockedUntil: { type: Date, default: null, alias: 'lockUntil' },
